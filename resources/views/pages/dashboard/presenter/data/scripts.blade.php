        ...
        const promiseDataAplikan = () => {
            ...
            Promise.all([
                ...
                .then((response) => {
                    ...
                    dataTableDataAplikanAplikanInstance = $('#table-report-data-aplikan').DataTable(
                        responseDTDAA.config);
                    dataTableDataAplikanAplikanInitialized = responseDTDAA.initialized;
                    dataTableDataAplikanDaftarInstance = $('#table-report-data-daftar').DataTable(
                        responseDTDAD.config);
