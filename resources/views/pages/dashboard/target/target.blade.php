@if (Auth::user()->role == 'P')
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pt-2 px-2 mt-3">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-3 mt-3">
            ...
            <div id="container-animate"
                ...
                <div class="hidden absolute top-[-60px] right-0" id="animate">
                    <dotlottie-player src="{{ asset('animations/win.lottie') }}" background="transparent" speed="1"
                        style="width: 150px; height: 150px" direction="1" mode="normal" loop
