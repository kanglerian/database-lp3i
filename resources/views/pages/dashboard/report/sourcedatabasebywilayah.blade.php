...
<section>
    <header class="space-y-1 mb-5">
        <div class="flex items-center gap-2">
            <i class="fa-regular fa-circle-dot"></i><h2 class="font-bold text-gray-800">Sumber Database Berdasarkan Wilayah</h2>
        </div>
        ...
        <script>
            ...
            const getDataTableDatabaseSchool = async () => {
                ...
                try {
                    ...
                    dataTableSourceDatabaseWilayahInstance = $('#table-source-database-wilayah').DataTable(dataTableConfig);
