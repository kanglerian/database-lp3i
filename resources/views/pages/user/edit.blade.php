            ...
            <div class="flex flex-col md:flex-row justify-start gap-5 p-4 md:p-0">
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" name="parent_phone" id="parent_phone"
                                        ...
                                        class="@error('parent_phone') border-red-500 @enderror block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                        placeholder=" " />
                                    <div class="text-sm text-gray-700 mt-3">
                ...
                <div class="w-full md:w-1/3 flex flex-col gap-3">
                    <form method="POST" class="p-6 bg-white border-b border-gray-200 rounded-xl"
                        action="{{ route('user.update_account', $user->id) }}">
                        @csrf
                        @method('PATCH')
                        <div>
                            <div>
                    ...
                    <form method="POST" class="p-6 bg-white border-b border-gray-200 rounded-xl"
                        action="{{ route('user.change_password', $user->id) }}">
                        @csrf
                        @method('PATCH')
                        <div>
                            <div class="relative z-0 w-full mb-6 group">
