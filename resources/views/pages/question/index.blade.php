        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-5">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 md:gap-3 px-4">
                <div class="bg-white p-5 rounded-xl border border-gray-200">
                    ...
                    <a href="{{ route('scholarship.index') }}" class="inline-block cursor-pointer text-xs bg-lp3i-100 hover:bg-lp3i-200 text-white px-4 py-2 rounded-lg mt-3">Lihat selengkapnya <i class="fa-solid fa-arrow-right-long"></i></a>
                </div>
            </div>
        </div>
    </div>
