    ...
    <main class="max-w-7xl mx-auto">
        <section class="grid grid-cols-1 md:grid-cols-3 gap-5">
            <a href="{{ route('presenters.sales_volume', $presenter->id) }}"
                class="relative bg-lp3i-200 hover:bg-lp3i-300 text-white cursor-pointer px-6 py-5 rounded-3xl transition ease-in-out space-y-1">
                <h2 class="font-bold space-x-1">
                    <i class="fa-solid fa-users"></i>
                    <span>Sales Volume</span>
                </h2>
                <p class="text-sm">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Explicabo,
                    consequuntur?</p>
