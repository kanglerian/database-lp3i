                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('presenter.update', $presenter->id) }}">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="nik" id="nik" value="{{ $presenter->nik }}"
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <select id="status" name="status"
                                    ...
                                    @switch($presenter->status)
                                        @case(1)
                                            <option value="{{ $presenter->status }}" selected>Aktif</option>
                                            <option value="0">Tidak Aktif</option>
                                        @break
                                        @case(0)
                                        <option value="{{ $presenter->status }}" selected>Tidak aktif</option>
