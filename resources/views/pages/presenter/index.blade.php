<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-5">
            ...
            <div class="flex flex-wrap justify-center items-center gap-3 text-gray-600">
                        ...
                        @forelse ($presenters as $key => $presenter)
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="px-6 py-4 bg-gray-50">
                                    <form action="{{ route('presenters.status', $presenter->id) }}" method="GET"
                                        class="inline-block">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    <form action="{{ route('presenters.destroy', $presenter->id) }}" method="post"
