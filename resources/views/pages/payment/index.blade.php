<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-3 py-5">
        <div class="flex justify-center items-center gap-5 px-5">
            <div
                class="max-w-sm p-6 bg-white border border-gray-200 rounded-xl">
                ...
                <p class="mb-3 font-normal text-xs text-gray-700">Berikut ini adalah informasi total registrasi awal. Untuk selengkapnya klik tombol di bawah ini.</p>
                <a href="{{ route('registration.index') }}"
            ...
            <div
                ...
                <p class="mb-3 font-normal text-xs text-gray-700">Berikut ini adalah informasi total potensi omset. Untuk selengkapnya klik tombol di bawah ini.</p>
                <a href="{{ route('registration.index') }}"
                    class="inline-flex items-center px-3 py-2 text-xs font-medium text-center text-white bg-lp3i-100 hover:bg-lp3i-200 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Lihat selengkapnya
                    <i class="fa-solid fa-arrow-right-long ml-2"></i>
