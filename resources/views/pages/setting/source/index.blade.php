<x-app-layout>
            ...
            <ol class="inline-flex items-center space-x-2 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-gray-500">Master Sumber Data</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <main class="max-w-7xl w-full mx-auto py-10">
        ...
        <section class="border border-gray-100 rounded-3xl p-8 space-y-4">
          <a href="{{ route('source.create') }}" class="inline-block text-white bg-lp3i-100 hover:bg-lp3i-200 focus:ring-4 focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-2.5">Tambah data</a>
                        ...
                        @forelse ($sources as $key => $source)
                            <tr class="bg-white border-b hover:bg-gray-50 transition-all ease-in-out">
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                    {{ $sources->perPage() * ($sources->currentPage() - 1) + $key + 1 }}
                                </th>
                                <td class="px-6 py-4">
                                    {{ $source->name }}
                                </td>
