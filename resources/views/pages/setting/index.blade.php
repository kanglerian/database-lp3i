<x-app-layout>
    ...
    <main>
        <section class="grid grid-cols-2 md:grid-cols-3 gap-3">
            <a href="{{ route('applicantstatus.index') }}" class="relative bg-lp3i-100 hover:bg-lp3i-200 transition-all ease-in-out text-white p-8 rounded-3xl">
                <div class="space-y-1">
            ...
            <a href="{{ route('followup.index') }}" class="relative bg-lp3i-100 hover:bg-lp3i-200 transition-all ease-in-out text-white p-8 rounded-3xl">
                <div class="space-y-1">
            ...
            <a href="{{ route('programtype.index') }}" class="relative bg-lp3i-100 hover:bg-lp3i-200 transition-all ease-in-out text-white p-8 rounded-3xl">
                <div class="space-y-1">
            ...
            <a href="{{ route('source.index') }}" class="relative bg-lp3i-100 hover:bg-lp3i-200 transition-all ease-in-out text-white p-8 rounded-3xl">
                <div class="space-y-1">
            ...
            <a href="{{ route('fileupload.index') }}" class="relative bg-lp3i-100 hover:bg-lp3i-200 transition-all ease-in-out text-white p-8 rounded-3xl">
                <div class="space-y-1">
